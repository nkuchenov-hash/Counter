...
| `stats/` | `stats_view.dart`, `stats_detail_tree.dart` | Productivity stats (embedded in Timeline): waking-day project/category time totals with expandable task groups and individual sessions |
