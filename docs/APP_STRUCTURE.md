...
| `stats/` | `stats_view.dart`, `stats_detail_tree.dart`, `stats_visual_overview.dart` | Productivity stats (embedded in Timeline): original expandable waking-day time tree plus top-level category donut and hourly day chart |
