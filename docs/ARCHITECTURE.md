...
- **RECURRENCE_HISTORY_IMMUTABILITY:** Recurring-plan bulk edits/deletes never rewrite occurrences before the selected boundary. “This and following” is implemented by splitting recurrence history at that occurrence; there is no user-facing whole-series retroactive mutation.
