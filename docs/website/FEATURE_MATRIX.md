...
| Desktop Price Reporter voice | Desktop only | `desktop_voice_command_panel.dart` (under `features/voice/`), `runtime_flags.dart` | Niche billing entry | do-not-market-yet | — | no | Kill switch default off |
