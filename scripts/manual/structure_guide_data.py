...
FOLDERS: dict[str, dict[str, str]] = {
    ...
    "lib/shared/voice/routing": {
        "what": "Voice submit / acceptance contracts without owning app tab state.",
        "why": "Shell owns active section; Voice only exposes submit callbacks.",
        "inside": "`desktop_voice_record_submit.dart`, `desktop_voice_acceptance_bridge.dart`.",
        "affects": "Shell Voice routing and acceptance hooks.",
        "when": "Parsed command → record write bridge or acceptance tests.",
        "delete": "No — shell Voice submit path breaks.",
    ...
    "lib/shared/voice/platforms": {
        "what": "Platform Voice adapters — desktop runtime/UI and mobile/web audio helpers.",
        "why": "Activation and recognition differ by OS; command semantics stay shared.",
        "inside": "`desktop/`, `desktop/ui/`, `mobile/`.",
        ...
        "related": "`lib/shared/voice/commands/`, `lib/data/voice/`.",
    },
    "lib/shared/voice/platforms/desktop": {
        "what": "Desktop Voice / STT runtime — hotkey, helper process, overlay, capture, prefs, benchmarks.",
        "why": "Windows desktop activation is an implementation of the shared Voice system, not a separate product.",
        "inside": "STT helper + orchestrator, hotkey, overlay, capture, settings, diagnostics, benchmarks.",
        ...
        "related": "`lib/shared/voice/platforms/desktop/ui/`, `lib/core/services/desktop_tray_service.dart`.",
    },
    "lib/shared/voice/platforms/desktop/ui": {
        "what": "Desktop-only Flutter Voice UI — widget, capsule, correction sheet, command panel.",
        "why": "Native overlay + Flutter Voice chrome are desktop-specific presentation.",
        ...
        "related": "`lib/shared/voice/platforms/desktop/`, `lib/app/shell/shared/shell_voice_routing.dart`.",
    },
    ...
    "lib/data/voice": {
        "what": "Brain Voice — parser, domain resolver, glossary, contamination/postprocess, cloud STT transport.",
        "why": "Live category index and PocketBase writes belong in Brain, not shared Voice.",
        "inside": "`voice_command_parser.dart`, domain resolver part, glossary, normalize, contamination, postprocess, cloud backend, Price Reporter client match.",
        "affects": "Voice command → category/record interpretation and cloud STT auth transport.",
        "when": "Parser/domain match wrong, cloud STT auth, glossary postprocess.",
        "delete": "No — Voice command execution breaks.",
        "related": "`lib/shared/voice/`, `lib/data/database_service.dart`.",
    },
