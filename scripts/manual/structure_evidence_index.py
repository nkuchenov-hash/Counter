...
WATCHLIST_PATHS: dict[str, str] = {
    "lib/core/widgets/plan_card/plan_card_controls.dart": (
        "Compatibility re-export of plan_time_task_card controls; no current production importer."
    ),
    "lib/core/widgets/plan_card/plan_card_geometry.dart": (
        "Compatibility re-export of plan_time_task_card geometry; no current production importer."
    ),
    "lib/core/widgets/plan_card/plan_card_metrics.dart": (
        "Compatibility re-export of plan_time_task_card metrics; no current production importer."
    ),
    "lib/core/widgets/plan_card/plan_card_sections.dart": (
        "Compatibility re-export of plan_time_task_card sections; no current production importer."
    ),
    "lib/core/widgets/plan_card/plan_time_card_density.dart": (
        "Compatibility re-export of plan_card_density; no current production importer."
    ),
    "lib/data/local_sync/plan_create_outbox.dart": (
        "Legacy re-export of plan_mutation_outbox.dart; zero current Dart importers."
    ),
    "lib/core/navigation/shell_side_navigation.dart": (
        "Compatibility re-export of shell/shell_side_navigation.dart; shell imports the canonical path."
    ),
    ...
    "lib/features/shared/profile_hydration_status_bar.dart": (
        "Compatibility re-export of shell/profile_hydration_status_bar.dart."
    ),
    "lib/core/widgets/confirm_dialog.dart": (
        "Design-system showConfirmDialog with zero production call sites; retained for V7 migration."
    ),
    "lib/core/widgets/life_card.dart": (
        "Design-system LifeCard/AppTaskCard foundation; not yet wired into production screens."
    ),
    ...
    "lib/features/shared/notes_editor/notes_editor_launcher.dart": (
        "Older Notes editor launcher; production uses note_editor_page.dart."
    ),
    "lib/features/shared/notes_editor/notes_editor_sheet.dart": (
        "Older Notes editor sheet; only reachable from the unused launcher."
    ),
    ...
    "lib/core/widgets/notes/notes.dart": (
        "Notes widget barrel only imported by unused notes_editor_sheet."
    ),
    "lib/core/widgets/notes/notes_context_row.dart": (
        "Notes context row; only reachable via unused notes editor stack."
    ),
    "lib/core/widgets/notes/notes_editor_surface.dart": (
        "Notes editor surface; only reachable via unused notes editor stack."
    ),
    "lib/core/widgets/notes/notes_markdown.dart": (
        "Notes markdown helper; only reachable via unused notes editor stack."
    ),
    "lib/core/widgets/notes/notes_save_status.dart": (
        "Notes save status chip; only reachable via unused notes editor stack."
    ),
    "lib/core/widgets/notes/notes_toolbar.dart": (
        "Notes toolbar; only reachable via unused notes editor stack."
    ),
    "lib/core/widgets/notes/note_preview_card.dart": (
        "Note preview card; only reachable via unused notes editor stack."
    ),
}
