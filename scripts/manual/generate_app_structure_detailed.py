...
def parse_app_structure_roles() -> dict[str, str]:
    ...
    for line in text.splitlines():
        if line.startswith("###"):
            ...
            if "3.36" in line and "shared/diagnostics" in line:
                current_prefix = "lib/shared/diagnostics/"
            if "3.37" in line and "shared/voice/diagnostics" in line:
                current_prefix = "lib/shared/voice/diagnostics/"
...
CATEGORY_GUIDES: dict[str, FileGuide] = {
    ...
    "lib/data/categories/category_crud.dart": FileGuide(
        ...
        delete="No — required for app runtime.",
        connected="`lib/features/settings/categories/`, category manager sheets.",
...
def enrich_with_evidence(path: str, g: FileGuide) -> FileGuide:
    ...
    # Final quality normalization: evidence enrichment is allowed to improve a
...
def finalize_file_guide(path: str, g: FileGuide) -> FileGuide:
    ...
    def safe_file_ru(field: str, value: str) -> str:
    ...
    return FileGuide(
        ...
        connected=g.connected,
        layer=g.layer,
        what_ru=safe_file_ru("what", pick("what_ru")),
        why_ru=safe_file_ru("why", pick("why_ru")),
        contains_ru=safe_file_ru("contains", pick("contains_ru")),
