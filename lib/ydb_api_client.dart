...
class YdbApiClient {
  ...
  /// PATCH /categories?id=&user_id= — body: { tag: ... }
  ...
  /// GET /records?user_id=&parent_id=&start_time_gte=&start_time_lt=&end_time_is_null=&limit=
  ...
  /// GET /records?user_id=&parent_id=&end_time_is_null=1&limit=1
  ...
  /// PATCH /records batch: set end_time for all matching user_id/parent_id where end_time IS NULL
  ...
  /// PUT /profiles (upsert by id in body)
  ...
  /// GET /plans?user_id=&start_time_gte=&start_time_lte
