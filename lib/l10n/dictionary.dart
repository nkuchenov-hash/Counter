...
const Map<String, Map<String, String>> l10n = {
  'en': {
    ...
    'stats_day_audit_title': 'Day audit',
    'stats_audit_plan': 'Plan',
    'stats_audit_fact': 'Fact',
    'stats_audit_postponed': 'Postponed',
    'stats_audit_postponed_list': 'Postponed (still on initial day)',
  ...
  'ru': {
    ...
    'stats_day_audit_title': 'Аудит дня',
    'stats_audit_plan': 'План',
    'stats_audit_fact': 'Факт',
    'stats_audit_postponed': 'Перенесено',
    'stats_audit_postponed_list': 'Перенесено (якорь на этот день)',
