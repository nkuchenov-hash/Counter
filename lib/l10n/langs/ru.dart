...
'app_title': 'Life OS',
    ...
    'profile_notifications_subtitle':
        'Разрешите Counter ставить локальные напоминания по планам на этом устройстве.',
    'profile_notifications_request_button': 'Разрешить и проверить уведомления',
    'profile_notifications_web_hint':
        'Отложенные напоминания недоступны в веб-версии.',
    ...
    'notif_test_title': 'Уведомления Counter работают',
    'notif_test_body': 'Теперь на этом устройстве могут появляться напоминания по планам.',
    'notif_test_sent': 'Тестовое уведомление отправлено.',
    'notif_test_failed':
        'Тестовое уведомление не показано. Проверьте системные настройки.',
    'notif_permission_denied_hint':
        'Разрешение всё ещё выключено. Включите уведомления в настройках системы.',
    ...
    'notes_v3_editor_image_too_large': 'Слишком большое изображение (макс. 2 МБ). Выберите меньше.',
