...
const Map<String, String> kRuL10n = {
  ...
  'tab_lists': 'Списки',
  'tab_more': 'Ещё',
  'tab_timeline_compact': 'Тайм',
  'tab_planning_compact': 'План',
  'tab_calendar_compact': 'Кал.',
  'tab_lists_compact': 'Списки',
  'tab_more_compact': 'Ещё',
  'lists_title': 'Списки',
  ...
  'browser_extension_added_plan': 'Добавлено в план на сегодня',
  'browser_extension_added_list': 'Добавлено в Списки',
  'browser_extension_add_failed': 'Не удалось добавить задачу из расширения браузера',
  'total': 'Всего',
  'logout': 'Выйти',
  'edit': 'Изменить',
  'delete': 'Удалить',
  ...
  'edit_save_time_required':
      'Укажите время начала и окончания перед сохранением.',
  ...
  'tag_default_durations_empty':
      'Сначала создайте теги планирования, затем задайте длительности.',
  ...
  'plan_reorder_failed':
      'Не удалось сохранить порядок. Проверьте сеть и повторите.',
  ...
  'category_create_requires_connection':
      'Создание категории требует подключения',
  'calendar': 'Календарь',
  ...
  'profile_password_reset_send_button': 'Отправить письмо для смены пароля',
  ...
  'profile_password_reset_no_email': 'Для этого аккаунта нет доступного email.',
  ...
  'desktop_voice_reason_no_root':
      'Сначала скажите «Price Reporter», затем клиента и задачу',
  'desktop_voice_reason_no_client': 'Клиент не найден в дереве категорий',
  'desktop_voice_reason_ambiguous_client':
      'Несколько клиентов подходят — повторите чётче',
  ...
  'desktop_voice_reason_invalid_category':
      'Неверная связь категории — синхронизируйте категории',
  'desktop_voice_reason_unsupported':
      'Команда не распознана — используйте поддерживаемый формат',
  ...
  'desktop_voice_listening':
      'Слушаю… скажите: Price Reporter [клиент] [задача]',
  'desktop_voice_parsing': 'Разбор команды…',
  'desktop_voice_resolved': 'Команда распознана — запуск записи',
  'desktop_voice_ambiguous':
      'Неоднозначный клиент — выберите вручную или повторите',
  'desktop_voice_no_match':
      'Безопасное совпадение не найдено — запись не создана',
  ...
  'desktop_voice_no_price_reporter':
      'Категория Price Reporter не найдена в дереве',
  'desktop_voice_preparing': 'Локальный движок речи (только диагностика)',
  'desktop_voice_listening_stop_hint':
      'Слушаю… нажмите «Готово», когда закончите говорить',
  ...
  'desktop_voice_settings_subtitle':
      'Горячая клавиша и виджет для команд Price Reporter (Windows)',
  ...
  'desktop_voice_settings_launch_hidden_hint':
      'Counter остаётся в трее для глобальной комбинации без открытия окна',
  ...
  'desktop_voice_hotkey_invalid_modifier':
      'Нельзя использовать только модификаторы',
  'desktop_voice_hotkey_need_modifier':
      'Нужен хотя бы один модификатор (Ctrl, Shift, Alt или Win)',
  ...
  'desktop_voice_mobile_unavailable':
      'Комбинации клавиш недоступны на этом устройстве.',
  ...
  'desktop_voice_widget_show_preview':
      'Показывать предпросмотр перед подтверждением',
  ...
  'desktop_voice_acceptance_planning': 'Проверка: Price Reporter Planning',
  ...
  // Редактор заметок (Stage 1 — Apple-Notes-like editor for plan/list notes)
  'notes_editor_title': 'Заметка',
  'notes_editor_open_in_notes': 'Открыть как заметку',
  'notes_editor_link_dialog_title': 'Вставить ссылку',
  'notes_editor_link_text_label': 'Текст ссылки',
  'notes_editor_link_url_label': 'URL',
  'notes_editor_nothing_to_copy': 'Нечего копировать',
  'notes_editor_clipboard_empty': 'Буфер обмена пуст',
  'notes_editor_no_markdown': 'Markdown не найден',
  'notes_editor_parse_failed': 'Не удалось разобрать буфер',
  'notes_editor_status_saving': 'Сохранение…',
  'notes_editor_status_saved': 'Сохранено',
  'notes_editor_status_offline': 'Офлайн · в очереди',
  'notes_editor_status_error': 'Ошибка сохранения',
  'notes_editor_retry': 'Повторить',
  'notes_editor_uncategorized': 'Без категории',
  'notes_editor_tags_tooltip': 'Метки',
  'notes_editor_divider_tooltip': 'Разделитель',
  'notes_editor_copy_md_tooltip': 'Копировать как Markdown',
  'notes_editor_paste_md_tooltip': 'Вставить из Markdown',
  'notes_editor_insert_link_tooltip': 'Вставить ссылку',
  'notes_editor_note_indicator': 'Заметка',
  'notes_editor_shared_badge': 'Общий',

  // Сортировка библиотеки заметок (Stage 2)
  'notes_sort_menu_tooltip': 'Сортировать заметки',
  'notes_sort_manual': 'Вручную',
  'notes_sort_modified': 'По изменению',
  'notes_sort_created': 'По созданию',
  'notes_sort_title': 'Заголовок (А → Я)',
  'notes_sort_category': 'По категории',
  'notes_sort_status': 'Готово / открыто',
  'notes_view_mode_notes': 'Вид заметок',
  'notes_view_mode_tasks': 'Вид задач',

  // Редактор заметок — верхняя панель / меню «Ещё» / статусы
  'notes_editor_more_tooltip': 'Ещё',
  'notes_editor_back_tooltip': 'Закрыть',
  'notes_editor_action_edit_details': 'Изменить детали',
  'notes_editor_action_edit_details_sub': 'Время, повтор, чек-лист',
  'notes_editor_action_copy_md': 'Копировать как Markdown',
  'notes_editor_action_paste_md': 'Вставить из Markdown',
  'notes_editor_action_insert_link': 'Вставить ссылку',
  'notes_editor_action_insert_divider': 'Вставить разделитель',
  'notes_editor_action_clear_format': 'Очистить формат',
  'notes_editor_action_convert_to_plan': 'Преобразовать в план',
  'notes_editor_action_ai_helper': 'ИИ-помощник',
  'notes_editor_action_share': 'Поделиться',
  'notes_editor_action_attach': 'Прикрепить файл',
  'notes_editor_action_delete': 'Удалить заметку',
  'notes_editor_group_primary': 'Заметка',
  'notes_editor_group_format': 'Форматирование',
  'notes_editor_group_future': 'Скоро',
  'notes_editor_group_danger': 'Опасная зона',
  'notes_editor_coming_soon_title': 'Скоро',
  ...
  'notes_library_empty_sub':
      'Нажмите на поле выше, чтобы добавить первую заметку.',
  ...
  // Notes v3 block editor + library (GLM port)
  'notes_v3_title': 'Заметки и списки',
  'notes_v3_subtitle': 'Заметки',
  'notes_v3_search_hint': 'Поиск заметок',
  'notes_v3_empty_title': 'Пока нет заметок',
  'notes_v3_empty_sub': 'Создайте первую заметку, чтобы начать.',
  'notes_v3_empty_create': 'Создать',
  'notes_v3_view_grid': 'Сетка',
  'notes_v3_view_list': 'Список',
  'notes_v3_checkbox_mode_on': 'Большие чекбоксы',
  'notes_v3_checkbox_mode_off': 'Скрыть чекбоксы',
  'notes_v3_all': 'Все',
  'notes_v3_count': '{n} заметок',
  'notes_v3_untitled': 'Без названия',
  'notes_v3_checklist_badge': 'Список',
  'notes_v3_draw_badge': 'Рисунок',
  'notes_v3_image_badge': 'Картинка',
  'notes_v3_more_count': '+{n} ещё',
  'notes_v3_just_now': 'только что',
  'notes_v3_min_ago': '{n} мин назад',
  'notes_v3_hr_ago': '{n} ч назад',
  'notes_v3_day_ago': '{n} дн назад',
  'notes_v3_edited': 'Изменено {when}',
  'notes_v3_just_created': 'Только создано',

  // Editor
  'notes_v3_editor_done': 'Готово',
  'notes_v3_editor_pin': 'Закрепить',
  'notes_v3_editor_unpin': 'Открепить',
  'notes_v3_editor_delete': 'Удалить заметку',
  'notes_v3_editor_delete_confirm': 'Удалить эту заметку?',
  'notes_v3_editor_title_hint': 'Заголовок',
  'notes_v3_editor_start_writing': 'Начните писать…',
  'notes_v3_editor_heading_hint': 'Заголовок',
  'notes_v3_editor_list_item_hint': 'Пункт списка',
  'notes_v3_editor_add_text': 'Текст',
  'notes_v3_editor_add_checklist': 'Список',
  'notes_v3_editor_add_heading': 'Заголовок',
  'notes_v3_editor_add_image': 'Картинка',
  'notes_v3_editor_add_draw': 'Рисовать',
  'notes_v3_editor_move_up': 'Вверх',
  'notes_v3_editor_move_down': 'Вниз',
  'notes_v3_editor_delete_block': 'Удалить блок',
  'notes_v3_editor_edit_drawing': 'Изменить рисунок',
  'notes_v3_editor_delete_image': 'Удалить картинку',
  'notes_v3_editor_status_editing': 'Изменение',
  'notes_v3_editor_status_saving': 'Сохранение…',
  'notes_v3_editor_status_saved': 'Сохранено',
  'notes_v3_editor_status_offline': 'Офлайн · ожидание',
  'notes_v3_editor_status_error': 'Ошибка · повтор',
  'notes_v3_editor_color_auto': 'Авто',
  'notes_v3_editor_color': 'Цвет текста',
  'notes_v3_editor_bold': 'Жирный',
  'notes_v3_editor_italic': 'Курсив',
  'notes_v3_editor_underline': 'Подчёркнутый',
  'notes_v3_editor_h1': 'Заголовок 1',
  'notes_v3_editor_h2': 'Заголовок 2',
  'notes_v3_editor_h3': 'Заголовок 3',
  'notes_v3_editor_checklist_toggle': 'Список',
  'notes_v3_editor_image_too_large':
      'Слишком большое изображение (макс. 2 МБ). Выберите меньше.',
  'notes_v3_editor_load_failed': 'Не удалось загрузить заметку. Повторите.',
  'notes_v3_editor_create_failed': 'Не удалось создать заметку. Повторите.',
  'notes_v3_editor_block_menu': 'Действия с блоком',
  'notes_v3_editor_select': 'Выбрать',
  'notes_v3_editor_open_note': 'Открыть заметку',
  ...
  'notes_drawing_close': 'Закрыть',
  'notes_drawing_undo': 'Отменить',
  'notes_drawing_clear': 'Очистить',
  'notes_drawing_save': 'Сохранить',
  ...
  'notes_tools_more_hint':
      'Действия блока и ссылки Life OS появляются здесь контекстно.',
