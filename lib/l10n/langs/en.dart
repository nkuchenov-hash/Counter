...
const Map<String, String> kEnL10n = {
  ...
  'lists_subitems_save_parent_first': 'Save this item first to add sub-items.',
  ...
  'stop': 'Stop',
  'add_task': 'Add Task',
  'browser_extension_added_plan': 'Added to today’s plan',
  'browser_extension_added_list': 'Added to Lists',
  'browser_extension_add_failed': 'Could not add the task from the browser extension',
  'total': 'Total Time',
  'logout': 'Logout',
  'edit': 'Edit',
  'delete': 'Delete',
  ...
  'tag_default_durations_empty':
      'Create planning tags first, then set durations here.',
  ...
  'plan_reorder_failed':
      'Could not save plan order. Check connection and retry.',
  ...
  'speech_error_network_soft': 'Connection issue. Please try dictating again.',
  ...
  'desktop_voice_reason_invalid_category':
      'Category link is invalid — sync categories and retry',
  'desktop_voice_reason_unsupported':
      'Command not recognized — try a supported format',
  ...
  'desktop_voice_settings_subtitle':
      'Hotkey voice widget for Price Reporter commands (Windows)',
  ...
  'desktop_voice_settings_launch_hidden_hint':
      'Keeps Counter running for the global hotkey without opening the main window',
  ...
  'desktop_voice_hotkey_need_modifier':
      'Include at least one modifier (Ctrl, Shift, Alt, or Win)',
  ...
  'desktop_voice_mobile_unavailable':
      'Keyboard shortcuts are not available on this device.',
  ...
  'desktop_voice_acceptance_planning':
      'Run acceptance: Price Reporter Planning',
  'desktop_voice_acceptance_age_mod':
      'Run acceptance: Price Reporter AGE SOLUTIONS ADD MOD',
  'desktop_voice_hotkey_register_error': 'Hotkey registration failed: %s',
  ...
  'profile_password_reset_no_email': 'No email is available for this account.',
  ...
  'notes_v3_title': 'Notes & Lists',
  'notes_v3_subtitle': 'Notes',
  'notes_v3_search_hint': 'Search notes',
  'notes_v3_empty_title': 'No notes yet',
  'notes_v3_empty_sub': 'Create your first note to get started.',
  'notes_v3_empty_create': 'Create one',
  'notes_v3_view_grid': 'Grid view',
  'notes_v3_view_list': 'List view',
  'notes_v3_checkbox_mode_on': 'Show large checkboxes',
  'notes_v3_checkbox_mode_off': 'Hide checkboxes',
  'notes_v3_all': 'All',
  'notes_v3_count': '{n} notes',
  'notes_v3_untitled': 'Untitled',
  'notes_v3_checklist_badge': 'Checklist',
  'notes_v3_draw_badge': 'Draw',
  'notes_v3_image_badge': 'Image',
  'notes_v3_more_count': '+{n} more',
  'notes_v3_just_now': 'just now',
  'notes_v3_min_ago': '{n}m ago',
  'notes_v3_hr_ago': '{n}h ago',
  'notes_v3_day_ago': '{n}d ago',
  'notes_v3_edited': 'Edited {when}',
  'notes_v3_just_created': 'Just created',

  // Editor
  'notes_v3_editor_done': 'Done',
  'notes_v3_editor_pin': 'Pin',
  'notes_v3_editor_unpin': 'Unpin',
  'notes_v3_editor_delete': 'Delete note',
  'notes_v3_editor_delete_confirm': 'Delete this note?',
  'notes_v3_editor_title_hint': 'Title',
  'notes_v3_editor_start_writing': 'Start writing…',
  'notes_v3_editor_heading_hint': 'Heading',
  'notes_v3_editor_list_item_hint': 'List item',
  'notes_v3_editor_add_text': 'Text',
  'notes_v3_editor_add_checklist': 'Checklist',
  'notes_v3_editor_add_heading': 'Heading',
  'notes_v3_editor_add_image': 'Image',
  'notes_v3_editor_add_draw': 'Draw',
  'notes_v3_editor_move_up': 'Move up',
  'notes_v3_editor_move_down': 'Move down',
  'notes_v3_editor_delete_block': 'Delete block',
  'notes_v3_editor_edit_drawing': 'Edit drawing',
  'notes_v3_editor_delete_image': 'Delete image',
  'notes_v3_editor_status_editing': 'Editing',
  'notes_v3_editor_status_saving': 'Saving…',
  'notes_v3_editor_status_saved': 'Saved',
  'notes_v3_editor_status_offline': 'Offline · pending',
  'notes_v3_editor_status_error': 'Error · retry',
  'notes_v3_editor_color_auto': 'Auto',
  'notes_v3_editor_color': 'Text color',
  'notes_v3_editor_bold': 'Bold',
  'notes_v3_editor_italic': 'Italic',
  'notes_v3_editor_underline': 'Underline',
  'notes_v3_editor_h1': 'Heading 1',
  'notes_v3_editor_h2': 'Heading 2',
  'notes_v3_editor_h3': 'Heading 3',
  'notes_v3_editor_checklist_toggle': 'Toggle checklist',
  'notes_v3_editor_image_too_large':
      'Image too large (max 2 MB). Choose a smaller image.',
  'notes_v3_editor_load_failed': 'Could not load note. Please retry.',
  'notes_v3_editor_create_failed': 'Could not create note. Please retry.',
  'notes_v3_editor_block_menu': 'Block actions',
  'notes_v3_editor_select': 'Select',
  'notes_v3_editor_open_note': 'Open note',
  'notes_v3_pin_indicator': 'Pinned',
  'notes_v3_checklist_progress': '{done}/{total}',

  'notes_image_source_title': 'Add image',
  ...
  'notes_audio_transcript_error':
      'Transcript failed. Audio is still available.',
  ...
  'notes_drawing_close': 'Close',
  'notes_drawing_undo': 'Undo',
  'notes_drawing_clear': 'Clear',
  'notes_drawing_save': 'Save',
  ...
  'notes_tools_more_hint':
      'Block actions and Life OS references will appear here contextually.',
