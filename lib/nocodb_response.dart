...
/// NocoDB v3 Data API (@DATA_MAP.md): column data lives under **`fields`**.
/// Bulk PATCH: `[{"id": <wrapper Id>, "fields": {...}}]`. POST create: `[{"fields": {...}}]`.
///
...
class NocoRequest {
  ...
  /// Without [id]: insert shape `{"fields":{...}}`. With [id]: `{"id":..., "fields":{...}}`.
