...
/// Category sibling-ordering helpers: optimistic apply, baseline seeding,
/// next-order computation, bulk PATCH (force vs diff-only), debounced
/// persistence, and immediate flush.
///
/// Order *state* fields (`_categoryOrderDebounceTimer`,
/// `_pendingCategoryOrderSyncList`, `_categoryReorderBaselineByLocalId`)
/// and the category cache (`_rules`, `_categoryController`) live in
/// [database_service.dart]; category-id resolution, tree queries, and
/// generic PATCH helpers are called across the library and stay defined
/// in their respective parts.
extension CategoryOrderingExtension on DatabaseService {
