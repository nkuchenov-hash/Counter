...
///
/// The item itself remains owned by the feature. This component owns the
/// discoverable drag handle and Flutter reorder plumbing so features do not
/// invent separate gesture behavior. Callers must update local order
/// immediately in [onReorder] and persist it asynchronously.
...
/// Canonical discoverable drag handle used by [AppReorderableList].
