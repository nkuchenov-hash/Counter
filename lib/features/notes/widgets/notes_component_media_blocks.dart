...
class NotesDrawingControls extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sliderDivisions = erasing ? 95 : 23;
    return SizedBox(
                  ...
                  child: DecoratedBox(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          scheme.surfaceContainerLow.withValues(alpha: 0.15),
...
class _NotesPhysicalToolPainter extends CustomPainter {
  ...
  void _pencil(Canvas canvas, Paint inkPaint, Paint edge) {
    final left = Path()
      ..moveTo(5, _bandTop)
      ..lineTo(15, 4)
      ..lineTo(11.6, _bandTop)
      ..close();
    final mid = Path()
      ..moveTo(11.6, _bandTop)
      ..lineTo(15, 4)
      ..lineTo(18.4, _bandTop)
      ..close();
    final right = Path()
      ..moveTo(18.4, _bandTop)
      ..lineTo(15, 4)
      ..lineTo(25, 30)
      ..lineTo(25, _bandTop)
      ..close();
  ...
  void _fineliner(Canvas canvas, Paint inkPaint, Paint collar, Paint edge) {
    final tip = RRect.fromRectAndRadius(
      const Rect.fromLTRB(13.75, 5.25, 16.25, 24),
  ...
  void _marker(Canvas canvas, Paint inkPaint, Paint collar, Paint edge) {
    final tip = Path()
      ..moveTo(10.6, 25)
      ..lineTo(11.5, 6)
      ..quadraticBezierTo(11.7, 4, 13.5, 4)
      ..lineTo(16.5, 4)
      ..quadraticBezierTo(18.3, 4, 18.5, 6)
      ..lineTo(19.4, 25)
      ..close();
    _shade(canvas, tip, inkPaint, edge);
    final neck = Path()
  ...
  void _highlighter(Canvas canvas, Paint inkPaint, Paint collar, Paint edge) {
    final tip = Path()
      ..moveTo(8.4, 24)
      ..lineTo(8.4, 12.6)
      ..quadraticBezierTo(8.4, 11.7, 9.2, 11.5)
      ..lineTo(20.4, 7.4)
      ..quadraticBezierTo(21.6, 7, 21.6, 8.5)
      ..lineTo(21.6, 24)
      ..close();
    _shade(canvas, tip, inkPaint, edge);
    final neck = Path()
  ...
  void _brush(Canvas canvas, Paint inkPaint, Paint metal, Paint edge) {
    final bristles = Path()
      ..moveTo(15, 4)
      ..cubicTo(17.4, 8.6, 19.9, 13.4, 20.6, 17.6)
      ..cubicTo(21.2, 21, 20.8, 23.8, 20, 26.4)
      ..lineTo(10, 26.4)
      ..cubicTo(9.2, 23.8, 8.8, 21, 9.4, 17.6)
      ..cubicTo(10.1, 13.4, 12.6, 8.6, 15, 4)
      ..close();
    _shade(canvas, bristles, inkPaint, edge);
    final ferrule = RRect.fromRectAndCorners(
      const Rect.fromLTRB(5, 25.2, 25, 33.6),
  ...
  void _eraser(Canvas canvas, Paint metal, Paint edge) {
    final rubberRect = RRect.fromRectAndRadius(
      const Rect.fromLTRB(6.8, 9, 23.2, 34),
    ...
    canvas.drawRect(
      const Rect.fromLTRB(5, 29, 25, 29.9),
