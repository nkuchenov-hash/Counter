...
extension PlanningTimeViewTimeViewCardLayer on PlanningTimeViewCoordinator {
  ...
  Widget buildTimelinePlanStackLayer({
    ...
    final heightPx = isResizing
        ...
        : layout.heightPx;
    const horizontalPad = PlanningTimeViewCoordinator.kTimelineBlockHorizontalPadPx;
          ...
          Positioned(
            ...
            child: Padding(
              padding: const EdgeInsets.symmetric(
                horizontal: PlanningTimeViewCoordinator.kTimelineBlockHorizontalPadPx,
              ),
              child: DecoratedBox(
        ...
        Positioned(
          ...
          child: Padding(
            ...
            child: TimelinePlanInteractionBlock(
              ...
              resizeHandlePx: PlanningTimeViewCoordinator.kTimelineResizeHandlePx,
